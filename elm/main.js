...
var author$project$Main$DownKey = {$: 'DownKey'};
var author$project$Main$EnterKey = {$: 'EnterKey'};
var author$project$Main$KeyPress = function (a) {
	return {$: 'KeyPress', a: a};
};
var author$project$Main$UpKey = {$: 'UpKey'};
var elm$json$Json$Decode$null = _Json_decodeNull;
var author$project$Main$down = _Platform_incomingPort(
	'down',
	elm$json$Json$Decode$null(_Utils_Tuple0));
var author$project$Main$enter = _Platform_incomingPort(
	'enter',
	elm$json$Json$Decode$null(_Utils_Tuple0));
var author$project$Main$up = _Platform_incomingPort(
	'up',
	elm$json$Json$Decode$null(_Utils_Tuple0));
...
var author$project$Main$subscriptions = elm$core$Platform$Sub$batch(
	_List_fromArray(
		[
			...
			function (_n0) {
				return author$project$Main$KeyPress(author$project$Main$EnterKey);
			}),
			author$project$Main$up(
			function (_n1) {
				return author$project$Main$KeyPress(author$project$Main$UpKey);
			}),
